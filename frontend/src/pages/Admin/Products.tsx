      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-lg shadow-gray-100/50 p-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-400 transition-all"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {filteredProducts.length === 0 ? (
          <div className="col-span-full bg-white rounded-2xl border border-gray-100 shadow-lg p-12 text-center">
            ...
            <button
              onClick={() => setIsCreateModalOpen(true)}
              className="mt-4 text-green-600 font-medium hover:text-emerald-700"
            >
              ...
              <div className="p-5">
                <div className="flex items-start justify-between gap-3 mb-3">
                  <div>
                    ...
                    <span className="inline-block mt-1 px-2 py-0.5 bg-emerald-50 text-emerald-600 text-xs font-medium rounded-full">
                      {product.category}
                    </span>
                  </div>
    ...
    <div className="space-y-5">
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
              {images.map((file, index) => (
                <div
                  key={index}
                  className="relative group aspect-square rounded-xl overflow-hidden border-2 border-green-200 bg-green-50"
                >
                  <img
      ...
      <div className="flex gap-3 pt-4 border-t border-gray-100">
        ...
        <button
          ...
          onClick={onSubmit}
          disabled={loading}
          className="flex-1 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white rounded-xl shadow-lg shadow-emerald-200 hover:shadow-xl transition-all font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {loading ? (
            <>
              <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
